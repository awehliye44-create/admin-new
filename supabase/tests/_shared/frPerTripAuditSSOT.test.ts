...
import { evaluateFrSettlementCaptureIdentity } from "../../functions/_shared/frConsumeOnlySSOT.ts";
import {
...
Deno.test("Financial Reconciliation edge handler has no money writes", async () => {
  const src = await Deno.readTextFile(
    new URL("../../functions/admin-finance-reconciliation/index.ts", import.meta.url),
  );
