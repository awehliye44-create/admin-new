...
const edgePath = new URL("../../functions/admin-company-outgoing-transfer/index.ts", import.meta.url);
const ssotPath = new URL("../../functions/_shared/companyTransferSoleAdminApprovalSSOT.ts", import.meta.url);
