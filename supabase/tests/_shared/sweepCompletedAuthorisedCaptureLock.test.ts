...
const capturePath = new URL("../../functions/_shared/revolutCompletionCapture.ts", import.meta.url);
const stopPath = new URL("../../functions/stop-workflow/index.ts", import.meta.url);
