...
} from "../../functions/_shared/holdReleasePure.ts";

const holdPath = new URL("../../functions/_shared/holdReleaseSSOT.ts", import.meta.url);
const sessionPath = new URL("../../functions/_shared/paymentSessionSSOT.ts", import.meta.url);
const abandonPath = new URL("../../functions/abandon-payment-session/index.ts", import.meta.url);
const sweepPath = new URL("../../functions/sweep-revolut-stale-holds/index.ts", import.meta.url);
const ctapPath = new URL("../../functions/create-trip-after-payment/index.ts", import.meta.url);
...
Deno.test("session-only release exports exist and never require a trip", async () => {
  ...
  const pure = await Deno.readTextFile(new URL("../../functions/_shared/holdReleasePure.ts", import.meta.url));
