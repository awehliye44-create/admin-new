-- MK-260817-006 gap close: ignore stale searching_expires_at while
-- dispatch_mode=scheduled and conversion is still pending.
-- Isolated: replace expire_trip_when_search_exhausted only.
