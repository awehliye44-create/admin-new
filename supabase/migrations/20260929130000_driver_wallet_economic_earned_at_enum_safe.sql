-- Step 4D.2 corrective migration (LOCAL until explicitly approved).
...
-- Enum-safe: payment_sessions.purpose is public.payment_session_purpose;
-- never COALESCE an enum to ''.
--
-- Does NOT:
