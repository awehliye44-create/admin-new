-- Fix get_driver_active_trip_snapshot: Postgres jsonb_build_object max 100 args.
-- Live function exceeded the limit (114 args), so Driver active-trip hydrate failed
-- and in-progress trips could not restore on launch/resume.
