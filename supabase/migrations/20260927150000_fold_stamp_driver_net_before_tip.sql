-- Stamp driver_net_before_tip_pence on modification fold (MK-260816-004).
-- Fold already wrote driver_net_pence; before_tip stayed at accept net so snapshot
-- COALESCE / thin payloads could resurface the stale accept fare on Driver.
