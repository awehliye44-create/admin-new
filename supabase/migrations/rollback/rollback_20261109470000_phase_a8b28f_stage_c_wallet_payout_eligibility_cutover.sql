-- A8B28F Stage C ROLLBACK
-- Restores pre-Stage-C live function bodies captured immediately before apply.
-- Does NOT mutate ledger, destinations, or drivers.payouts_enabled / payout_operational_paused rows.
