-- Restores tr_stamp_offer_presets_fn from 20260924150000_stamp_net_display_when_wave_equals_gross.sql.
-- Does not rewrite historical ride_offers. Do not apply unless rolling back 20261112170000.
