-- Fix stacked eligibility: compare queued_count to Admin max_stacked_rides.
-- Require exactly one active trip. Fail closed when max_stacked_rides missing/invalid.
-- Generated from production function body + surgical stack_ok edits.
