-- ============================================================
-- Phase A8A: suspend_corporate_account authorization
...
-- super_admin and admin can_access; other staff roles cannot.
...
-- Authenticated EXECUTE stays. No ACL change. Suspension logic unchanged.
-- No audit write in current body — do not add one in this batch.
-- ============================================================
...
COMMENT ON FUNCTION public.suspend_corporate_account(uuid) IS
  'Phase A8A: service_role OR staff_has_page_access(corporate-accounts). Fail closed. Suspension logic unchanged.';
