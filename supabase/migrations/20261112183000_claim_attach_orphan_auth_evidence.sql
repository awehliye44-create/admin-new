-- Migration 20261112183000: claim attaches orphan PSA auth evidence to TCR
-- When increment already wrote ADDITIONAL_AUTHORISATION_CONFIRMED without
-- trip_change_request_id, claim must link it so hold-already-covers fare
-- increases can apply (MK-260916-030 follow-up).
-- Rollback: rollback/rollback_20261112183000_claim_attach_orphan_auth_evidence.sql
BEGIN;
