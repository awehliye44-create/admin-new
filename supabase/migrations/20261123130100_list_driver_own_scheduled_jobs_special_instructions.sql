-- Pin list_driver_own_scheduled_jobs in-repo (live already selects special_instructions).
-- Driver scheduledJobsAdapter maps special_instructions → passengerNotes.
