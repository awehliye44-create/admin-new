...
const AUTO_INVOICE_TRIP_SELECT =
  "id, passenger_id, status, completed_at, financial_outcome, payment_method, payment_status, provider_order_id, payment_intent_id, tip_window_closed_at, tip_window_expires_at, tip_window_status, invoice_email_sent";
