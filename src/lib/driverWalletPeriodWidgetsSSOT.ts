/**
 * Pure period aggregation helpers (mirror of backend driverWalletPeriodWidgetsSSOT).
 * UI must display backend wallet_summary only — do not call these from React components.
 * Kept for unit tests and parity with edge SSOT.
 */

import { earningsAttributionInstant } from '@shared/economicEarnedAtSSOT';
