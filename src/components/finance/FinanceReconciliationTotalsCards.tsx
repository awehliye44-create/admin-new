      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">Net Customer Revenue</CardTitle>
            <CreditCard className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{fmt(FinanceSSOT.netCustomerRevenue(summary), cc)}</div>
            <p className="text-xs text-muted-foreground">
              Captured {fmt(FinanceSSOT.totalCustomerRevenue(summary), cc)} − refunds {fmt(FinanceSSOT.refundedAmount(summary), cc)}
            </p>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent className="text-sm space-y-1">
            <div className="flex justify-between"><span>Gross earnings</span><span>{fmt(FinanceSSOT.driverGrossEarnings(summary), cc)}</span></div>
            <div className="flex justify-between"><span>Net earnings</span><span>{fmt(FinanceSSOT.driverNetEarnings(summary), cc)}</span></div>
