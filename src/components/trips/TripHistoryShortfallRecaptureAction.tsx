...
export function TripHistoryShortfallRecaptureAction({
  ...
  const evidence = useMemo(() => {
    ...
    return buildTripHistoryPaymentEvidenceReadModel({
      trip: {
        ...trip,
        // Keep tip-exclusive final_* stamps. Never overwrite with tip-inclusive aggregate.
      ...
      sessions: captured > 0
        ...
        : undefined,
      // Edge already resolved tip once — authoritative aggregate, never add tip again.
      customer_payable_pence: payable > 0 ? payable : null,
